...
def calcular_volumen_prisma(base, altura, prof):
    return base * altura * prof

def calcular_volumen_piramide(base, altura, prof):
    return (1/3) * base * altura * prof
...
if opcion == 1:
    ...
    prof = float(input("Ingrese la profundidad del prisma en metros: "))
    volumen = calcular_volumen_prisma(base, altura, prof)
    solido = "prisma"
elif opcion == 2:
    ...
    prof = float(input("Ingrese la medida de profundidad de la piramide en metros: "))
    volumen = calcular_volumen_piramide(base, altura, prof)
    solido = "pirámide"
elif opcion == 3:
