...
imagen_original = cv2.imread('c:/Users/danie/OneDrive/Desktop/DanielCar99/TALLER_1/Parte_c/logo2.jpg')
imagen_original = cv2.resize(imagen_original, None, fx=0.2, fy=0.2)  # Redimensionar a la mitad
